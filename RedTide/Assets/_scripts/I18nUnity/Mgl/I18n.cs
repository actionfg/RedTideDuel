...
namespace Mgl
{
    public sealed class I18n
    {
        ...
        private static string[] locales = new string[] { "en-US", "fr-FR", "zh-CN" };
        ...
        public delegate void OnLanguageChangeDelegate(string language);
        ...
        static void InitConfig()
        {
            if (locales.Contains(_currentLocale))
            {
                ...
                {
                    OnLanguageChange(_currentLocale);
                }
            }
