...
public class AIPath : MonoBehaviour {
    ...
    public virtual void SetTargetPos(Vector3 targetLoc, bool reset = true)
    {
        TargetPos = targetLoc;
	    if (reset)
	    {
	...
	public float TrySearchPath () {
		if (Time.time - lastRepath >= repathRate && canSearchAgain && canSearch && (target != null || TargetPos != Vector3.zero)) {
			SearchPath ();
			return repathRate;
		} else {
	...
	public virtual void SearchPath () {
		...
		if (target == null && TargetPos == Vector3.zero) throw new System.InvalidOperationException ("Target is null");
    ...
    public virtual Vector3 GetActualTargetLoc()
    {
...
//		}
	 ...
	 */
	protected virtual Vector3 CalculateTargetPoint (Vector3 p, Vector3 a, Vector3 b) {
		a.y = p.y;
		b.y = p.y;
